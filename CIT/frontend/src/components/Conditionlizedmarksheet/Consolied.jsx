...
const Consolied = () => {
  return (
    <>
    <Breadcrumb Home="Home" PageName="Consolidated Marksheet" />
      ...
      <div className="mx-auto max-w-screen-2xl px-4 ">
        <div className="mb-4  sm:mb-8 md:mb-12">
          <div className="">
            ...
            Consolidated Mark sheet and Provisional Degree Certificate
            </h2>
            ...
            <ol className="list-decimal text-black dark:text-gray-300 md:block px-5">
              <li className='py-2'>Download relevant application form <a href='https://www.rtu.ac.in/RTU/wp-content/uploads/2015/05/Form-for-Consolidated-mark-sheet.pdf' target='blank' className='text-blue-500'>from here.</a> </li>
