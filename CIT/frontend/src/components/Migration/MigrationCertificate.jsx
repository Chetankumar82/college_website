...
const MigrationCertificate = () => {
  return (
    <>
        <Breadcrumb Home="Home" PageName="Migration Certificate" />
      ...
      <div className="mx-auto max-w-screen-2xl px-4 ">
        <div className="mb-4  sm:mb-8 md:mb-12">
          <div className="">
            ...
            To get your Migration Certificate please go through following steps:
            </h4>
            <ol className="list-decimal text-black dark:text-gray-300 md:block px-5">
              <li className='py-2'>Download relevant application form <a href='https://www.rtu.ac.in/RTU/wp-content/uploads/2015/10/migrationcertificate.pdf' target='blank' className='text-blue-500'>from here.</a> </li>
              ...
              <li className='py-2'>Enclose a D/D of Rs.150/- in favour of Registrar, Rajasthan Technical University, Kota. Payable at Kota.</li>
